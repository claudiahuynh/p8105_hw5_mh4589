...
As the true mean deviates more from the null, which states that the true mean equals 0, the power of the test increases. In other words, as effect size increases, the power of the test increases. This relationship is not linear but resembles the shape of a sigmoid curve. The power gradually increases for smaller effect sizes, and rapidly increases as effective size increases and plateaus when power reaches 1. 
